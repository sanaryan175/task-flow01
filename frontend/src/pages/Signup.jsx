...
/**
 * Signup page — shown when user wants to create an account.
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl shadow-gray-200/60 dark:shadow-gray-900/40 border border-gray-100 dark:border-gray-700/60 p-8">
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            <AuthInput id="signup-name" label="Full Name" value={name}
              onChange={(e) => setName(e.target.value)} placeholder="Jane Smith" autoComplete="name" />
            <AuthInput id="signup-email" label="Email" type="email" value={email}
              onChange={(e) => setEmail(e.target.value)} placeholder="you@example.com" autoComplete="email" />
            <AuthInput id="signup-password" label="Password" type="password" value={password}
...
Signup.propTypes = { onSwitch: PropTypes.func.isRequired };
